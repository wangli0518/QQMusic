...
export default class RunRight extends Component {
    constructor() {
        super();
        this.state = {rowList: []}
    }
    ...
    render() {
        return (
            <div className='outer'>
                ...
                <img className='bot-pic'
                     src="http://img10.yiguoimg.com/d/items/2018/180427/9288722265580699_1125x652.jpg?w=1125&h=652"
                     alt=""/>
            </div>
        )
    }
